...
The fixture proves assertion semantics in Node. Rendering remains **unobserved** until an
adopter records a real-browser receipt for its DOM, CSP, load order, and visible states.
