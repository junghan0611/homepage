---
title: "Preface"
description: "The complete English preface and a Korean reading translation of SICM, pinned to its exact source."
type: eval
...
#+begin_quote
  ...
  [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_5][5]]], footnote,
...
@@html:<span id="pxiv"></span>@@understanding. Traditional mathematical notation contributes to
this problem. Symbols have ambiguous meanings that depend on context,
and often even change within a given context.@@html:<sup><a id="endnote_ref_1" href="#endnote_1">1</a></sup>@@ For
...
{{< sicm-math >}}\frac{d}{dt}\frac{\partial L}{\partial{\dot{q}}^{i}} - \frac{\partial L}{\partial q^{i}} = 0.{{< /sicm-math >}}

The Lagrangian /L/ must be interpreted as a function of the position and
velocity components /q^{i}/ and

{{< sicm-math >}}{\dot{q}}^{i}{{< /sicm-math >}}
...
modern mathematical presentations.@@html:<sup><a id="endnote_ref_2" href="#endnote_2">2</a></sup>@@ An introduction
to our functional notation is in an appendix.

Computation also enters into the presentation of the mathematical ideas
underlying mechanics. We require that our @@html:<span id="pxv"></span>@@mathematical notations
...
follows:@@html:<sup><a id="endnote_ref_3" href="#endnote_3">3</a></sup>@@
...
ambiguity.@@html:<sup><a id="endnote_ref_4" href="#endnote_4">4</a></sup>@@ The partial derivatives of the Lagrangian
...
motion of systems through simulation and @@html:<span id="pxvi"></span>@@experiment. The
...
@@html:<span id="pxviii"></span>@@importance of the coordinate independence of the action. We
...
@@html:<span id="endnote_1"></span><a href="#endnote_ref_1"><sup>1</sup></a>@@In his book on mathematical pedagogy
[[[https://tgvaughan.github.io/sicm/bibliography.html#bib_17][17]]], Hans Freudenthal argues that
...
@@html:<span id="endnote_2"></span><a href="#endnote_ref_2"><sup>2</sup></a>@@In his beautiful book /Calculus on Manifolds/
[[[https://tgvaughan.github.io/sicm/bibliography.html#bib_40][40]]], Michael Spivak uses functional
...
{{< sicm-math >}}\frac{\partial f(g(x,y),h(x,y)}{\partial x} = \frac{\partial f(u,v)}{\partial u}\frac{\partial u}{\partial x} + \frac{\partial f(u,v)}{\partial v}\frac{\partial v}{\partial x}{{< /sicm-math >}}
[The symbol ∂/u//∂/x/ means ∂///∂/x g/(/x, y/), and ∂///∂/u f/(/u, v/)
means /D/_{1}/f/(/u, v/) = /D/_{1}/f/(/g/(/x, y/), /h/(/x, y/)).] This
equation is often written simply

{{< sicm-math >}}\frac{\partial f}{\partial x} = \frac{\partial f}{\partial u}\frac{\partial u}{\partial x} + \frac{\partial f}{\partial v}\frac{\partial v}{\partial x}.{{< /sicm-math >}}
Note that /f/ means something different on the two sides of the
equation!

@@html:<span id="endnote_3"></span><a href="#endnote_ref_3"><sup>3</sup></a>@@This is presented here without explanation, to
give the flavor of the notation. The text gives a full explanation.

@@html:<span id="endnote_4"></span><a href="#endnote_ref_4"><sup>4</sup></a>@@“It is necessary to use the apparatus of partial
derivatives, in which even the notation is ambiguous.” V.I. Arnold,
/Mathematical Methods of Classical Mechanics/
[[[https://tgvaughan.github.io/sicm/bibliography.html#bib_5][5]]], Section 47, p. 258. See also the
