...
Albert Einstein, /Relativity, the Special and General Theory/ [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_16][16]]], [[#p9][p. 9]]
#+end_quote
...
{L = L_{f} \circ C.} & {(1.104)}
    ...
    [[/eval/sicm/chapter-1/#p40][page 40]], the /T/ − /V/ Lagrangian for a free
...
'thetadot)))
    ...
    [[/eval/sicm/chapter-1/#p51][page 51]].
...
(define ((monitor-theta win) state) (let ((theta
   ...
   *a.* Evolve the Foucault pendulum, using the Lagrangian you constructed in
   ...
   [[/eval/sicm/chapter-1/#p62][page 62]]. You should look at the precession
...
(define ((V a GM0 GM1 m) t xy) (let ((Omega (sqrt (/
    ...
    did on [[/eval/sicm/chapter-1/#p48][page 48]]. The resulting Lagrangian is
...
1))))) ((Gamma-bar DF-on-path) state))) DtF)
  ...
  *Exercise 1.37: Velocity transformation*
  ...
  ([[/eval/sicm/chapter-1/#disp_1.67][1.67]]) on [[/eval/sicm/chapter-1/#p42][page
  42]].
...
[fn:90] This F->C is more general than the code introduced on [[/eval/sicm/chapter-1/#p46][page 46]] in that it
