...
{0 = {\int_{t_{1}}^{t_{2}}{\left\{ (\partial_{1}L \circ \Gamma\lbrack q\rbrack) - D(\partial_{2}L \circ \Gamma\lbrack q\rbrack) \right\}\,\eta.}}} & {(1.34)}
   ...
   realizable path. Thus ([[/eval/sicm/chapter-1/#disp_1.34][1.34]]) must be true for /any/ function $\eta$ that is
...
{(\partial_{1}\psi \circ \Gamma\lbrack q\rbrack)\eta + (\partial_{2}\psi \circ \Gamma\lbrack q\rbrack)D\eta = 0.} & {(1.235)}
    ...
    al. [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_6][6]]], translated into our notation. Define a “virtual velocity” $\xi$ to
...
{\mathcal{E}\lbrack L\rbrack \circ \Gamma\lbrack q\rbrack = \lambda(\partial_{2}\psi \circ \Gamma\lbrack q\rbrack),} & {(1.238)}
    ...
    must replace $\eta$ by $\xi$. However, to get from equation ([[/eval/sicm/chapter-1/#disp_1.235][1.235]]) to
    equation ([[/eval/sicm/chapter-1/#disp_1.236][1.236]]), we must set $\eta = 0$ and replace /Dη/ by $\xi$. All
