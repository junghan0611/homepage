...
description: "The complete first chapter of SICM with source receipts and computation-derived Emmy views."
type: eval
...
sicmSource: "en/chapter001.org"
sicmTranslation: false
...
* 1.2 Generalized Coordinates
  ...
  In general, the configurations form a space {{< sicm-math >}}M{{< /sicm-math >}} of some dimension {{< sicm-math >}}n{{< /sicm-math >}}. The
  {{< sicm-math >}}n{{< /sicm-math >}}-dimensional configuration space can be parameterized by choosing a
  coordinate function {{< sicm-math >}}\chi{{< /sicm-math >}} that maps elements of the configuration space to
  {{< sicm-math >}}n{{< /sicm-math >}}-tuples of real numbers.[fn:5] If there is more than one dimension, the
  function {{< sicm-math >}}\chi{{< /sicm-math >}} is a tuple of {{< sicm-math >}}n{{< /sicm-math >}} independent coordinate functions[fn:6]
  ...
  a /coordinate path/ {{< sicm-math >}}q = \chi \circ \gamma{{< /sicm-math >}} mapping time to tuples of
  generalized coordinates.[fn:9] If there is more than one degree of freedom the
  coordinate path is a structured object: {{< sicm-math >}}q{{< /sicm-math >}} is a tuple of component coordinate
  path functions {{< sicm-math >}}q^i = \chi^i \circ \gamma{{< /sicm-math >}}. At each instant of time {{< sicm-math >}}t{{< /sicm-math >}}, the
  values {{< sicm-math >}}q(t) = \left(q^0(t),\, \ldots,\, q^{n−1}(t) \right){{< /sicm-math >}} are the
  generalized coordinates of a configuration.

  The derivative {{< sicm-math >}}Dq{{< /sicm-math >}} of the coordinate path {{< sicm-math >}}q{{< /sicm-math >}} is a function[fn:10] that gives
...
*** Exercise 1.2: Generalized coordinates
    ...
    For each of the systems in [[/eval/sicm/chapter-1/#Exe_1-1][exercise 1.1]], specify a system of generalized
...
(show-expression
 ((compose (L-free-particle 'm) (Gamma q)) 't))
  ...
  According to equation ([[/eval/sicm/chapter-1/#disp_1.4][1.4]]) we can compute the Lagrangian action from time
...
** Paths of minimum action
   ...
   a straight-line test path than along nearby paths. Let {{< sicm-math >}}q{{< /sicm-math >}} be a straight-line
   test path with action {{< sicm-math >}}S\left[q\right](t_1, t_2){{< /sicm-math >}}. Let {{< sicm-math >}}q + \varepsilon \eta{{< /sicm-math >}}
   be a nearby path, obtained from {{< sicm-math >}}q{{< /sicm-math >}} by adding a path variation {{< sicm-math >}}\eta{{< /sicm-math >}} scaled
   by the real parameter {{< sicm-math >}}\varepsilon{{< /sicm-math >}}.[fn:37] The action on the varied path is
   {{< sicm-math >}}S\left[q + \varepsilon \eta\right](t_1, t_2){{< /sicm-math >}}. Euler and Lagrange found that
   {{< sicm-math >}}S\left[q + \varepsilon \eta\right](t_1, t_2) > S\left[q\right](t_1, t_2){{< /sicm-math >}}
   for any {{< sicm-math >}}\eta{{< /sicm-math >}} that is zero at the endpoints and for any small nonzero
   {{< sicm-math >}}\eta{{< /sicm-math >}}.

   Let's check this numerically by varying the test path, adding some amount of
   a test function that is zero at the endpoints {{< sicm-math >}}t = t_1{{< /sicm-math >}} and {{< sicm-math >}}t = t_2{{< /sicm-math >}}. To
   make a function {{< sicm-math >}}\eta{{< /sicm-math >}} that is zero at the endpoints, given a sufficiently
...
{{< sicm-math display >}}\begin{array}{lll} {Dg(0)} & {= {\int_{t_{1}}^{t_{2}}{(\partial_{1}L(t,q(t),Dq(t))\eta(t))\,\, dt}}} & \\ & {+ \,\partial_{2}L(t,q(t),Dq(t)D\eta(t))\eta(t)|_{t_{1}}^{t_{2}}} & \\ & {- {\int_{t_{1}}^{t_{2}}{\frac{d}{dt}(\partial_{2}L(t,q(t),Dq(t)))\eta(t)dt}}.} & {(1.16)}\end{array}{{< /sicm-math >}}
   ...
   first order in /ϵ/, /ϵDg/(0). Because {{< sicm-math >}}\eta{{< /sicm-math >}} is zero at the endpoints the
...
{\Delta S = \mathit{\epsilon}{\int_{t_{1}}^{t_{2}}\left\{ \partial_{1}L \circ \Gamma\lbrack q\rbrack\, - \, D(\partial_{2}L \circ \Gamma\lbrack q\rbrack) \right\}}\eta.} & {(1.17)}
   ...
   choice of the variation that the factor in the integrand multiplying {{< sicm-math >}}\eta{{< /sicm-math >}}
   ...
   to be nonzero in at least one of its components. But if we choose our {{< sicm-math >}}\eta{{< /sicm-math >}}
...
** The Variation Operator
   ...
   /q/ + /ϵη/ be a varied path, where the function {{< sicm-math >}}\eta{{< /sicm-math >}} is a path-like
...
{\delta_{\eta}f\lbrack q\rbrack = \underset{\mathit{\epsilon}\rightarrow 0}{\lim}\left( \frac{f\lbrack q + \mathit{\epsilon}\eta\rbrack - f\lbrack q\rbrack}{\mathit{\epsilon}} \right).} & {(1.19)}
   ...
   /f/ for small variations in the path. The variation of /f/ depends on {{< sicm-math >}}\eta{{< /sicm-math >}}.
...
\end{aligned}{{< /sicm-math >}}
   ...
   particular function {{< sicm-math >}}\eta{{< /sicm-math >}} to /q/. So the statement /δ_{η}f/[/q/] = 0 for
   arbitrary {{< sicm-math >}}\eta{{< /sicm-math >}} implies the function /f/ is stationary for small variations
...
(define (((delta eta) f) q) ... )
   ...
   *b.* Use your delta procedure to verify the properties of /δ/ listed in
   [[/eval/sicm/chapter-1/#Exe_1-7][exercise 1.7]] for simple functions such as implemented by the procedure
   f:[fn:51]
...
{S\lbrack q\rbrack(t_{1},t_{2}) = {\int_{t_{1}}^{t_{2}}{L \circ \Gamma\lbrack q\rbrack.}}} & {(1.28)}
   ...
   variation {{< sicm-math >}}\eta{{< /sicm-math >}} that preserves the endpoints, /η/(/t/_{1}) = /η/(/t/_{2}) =
   0, is zero:
...
{\delta_{\eta}\Gamma\lbrack q\rbrack(t) = (0,\eta(t),D\eta(t)),} & {(1.31)}
   \end{aligned}{{< /sicm-math >}}
   which follows from equations ([[/eval/sicm/chapter-1/#disp_1.20][1.20]]) and ([[/eval/sicm/chapter-1/#disp_1.21][1.21]]), and using the chain rule for
   variations ([[/eval/sicm/chapter-1/#disp_1.26][1.26]]), we get[fn:52]
...
{{< sicm-math display >}}\begin{array}{lll} {\delta_{\eta}S\lbrack q\rbrack(t_{1},t_{2})} & {= {\int_{t_{1}}^{t_{2}}{(D\, L \circ \Gamma\lbrack q\rbrack)\delta_{\eta}\Gamma\lbrack q\rbrack}}} & \\ & {= {\int_{t_{1}}^{t_{2}}{((\partial_{1}L \circ \Gamma\lbrack q\rbrack)\eta + (\partial_{2}L \circ \Gamma\lbrack q\rbrack)D\eta).}}} & {(1.32)}\end{array}{{< /sicm-math >}}
   Integrating the last term of equation ([[/eval/sicm/chapter-1/#disp_1.32][1.32]]) by parts gives
...
{{< sicm-math display >}}\begin{array}{lll} {\delta_{\eta}S\lbrack q\rbrack(t_{1},t_{2}) =} & {(\partial_{2}L \circ \Gamma\lbrack q\rbrack)\eta|_{t_{1}}^{t_{2}}} & \\ & {+ {\int_{t_{1}}^{t_{2}}{\left\{ (\partial_{1}L \circ \Gamma\lbrack q\rbrack) - D(\partial_{2}L \circ \Gamma\lbrack q\rbrack) \right\}\eta.}}} & {(1.33)}\end{array}{{< /sicm-math >}}
   For our variation {{< sicm-math >}}\eta{{< /sicm-math >}} we have /η/(/t/_{1}) = /η/(/t/_{2}) = 0, so the
   first term vanishes.
...
{0 = {\int_{t_{1}}^{t_{2}}{\left\{ (\partial_{1}L \circ \Gamma\lbrack q\rbrack) - D(\partial_{2}L \circ \Gamma\lbrack q\rbrack) \right\}\,\eta.}}} & {(1.34)}
   ...
   realizable path. Thus ([[/eval/sicm/chapter-1/#disp_1.34][1.34]]) must be true for /any/ function {{< sicm-math >}}\eta{{< /sicm-math >}} that is
   zero at the endpoints. Since {{< sicm-math >}}\eta{{< /sicm-math >}} is arbitrary, except for being zero at
...
{L(t;\xi,\eta;v_{\xi},v_{\eta}) = \frac{1}{2}m(v_{\xi}^{2} + v_{\eta}^{2}) + \frac{\mu}{\sqrt{\xi^{2} + \eta^{2}}},} & {(1.42)}
   \end{aligned}{{< /sicm-math >}}
   where {{< sicm-math >}}\xi{{< /sicm-math >}} and {{< sicm-math >}}\eta{{< /sicm-math >}} are formal parameters for rectangular coordinates of
...
*** 1.5.2 Computing Lagrange's Equations
    ...
    expression ([[/eval/sicm/chapter-1/#disp_1.12][1.12]]), where the procedure Gamma implements Γ:[fn:56]
...
(define ((Lagrange-equations Lagrangian) q)
  (- (D (compose ((partial 2) Lagrangian) (Gamma q)))
    ...
    the left-hand side of the Lagrange equations ([[/eval/sicm/chapter-1/#disp_1.12][1.12]]). These residual values
...
** The free particle
   ...
   minimizing the action, as we did in [[/eval/sicm/chapter-1/#h1-5][section 1.4]], we can check Lagrange's
...
** The harmonic oscillator
   ...
   :CLASS:    level2
   :END:
   Consider the harmonic oscillator again, with Lagrangian ([[/eval/sicm/chapter-1/#disp_1.10][1.10]]). We know that
...
{n^{2}a^{3} = G(m_{1} + m_{2})} & {(1.52)}
   ...
   *Exercise 1.12: Lagrange's Equations*
   ...
   Compute Lagrange's equations for the Lagrangians in [[/eval/sicm/chapter-1/#Exe_1-9][exercise 1.9]] using the
   ...
   [[/eval/sicm/chapter-1/#Exe_1-9][exercise 1.9]].
   ...
   *a.* Write a procedure to compute the Lagrange equations for Lagrangians that
   depend upon acceleration, as in [[/eval/sicm/chapter-1/#Exe_1-10][exercise 1.10]]. Note that Gamma can take an
...
{D(\partial_{2}L \circ \Gamma\lbrack x\rbrack) - \partial_{1}L \circ \Gamma\lbrack x\rbrack = 0.} & {(1.56)}
  \end{aligned}{{< /sicm-math >}}
  Observe that Newton's equations ([[/eval/sicm/chapter-1/#disp_1.55][1.55]]) are
  just the components of the Lagrange equations
  ([[/eval/sicm/chapter-1/#disp_1.56][1.56]]) if we choose /L/ to have the
  properties
...
{\partial_{1}L(t;\mathbf{x}_{0},\ldots,\mathbf{x}_{N - 1};\mathbf{v}_{0},\ldots,\mathbf{v}_{N - 1})} & \\
  ...
  required properties
  ([[/eval/sicm/chapter-1/#disp_1.58][1.58]]--[[/eval/sicm/chapter-1/#disp_1.59][1.59]])
  is
...
{mD^{2}y(t) = - \frac{y(t)}{r(t)}DU(r(t)),} & {(1.63)}
   ...
   between rectangular coordinates {{< sicm-math >}}(x, y){{< /sicm-math >}} and polar coordinates {{< sicm-math >}}(r, \varphi){{< /sicm-math >}}
   is
...
\begin{aligned}
   ...
   {{< sicm-math >}}\widetilde{x}{{< /sicm-math >}}

   and

   {{< sicm-math >}}\widetilde{y}{{< /sicm-math >}}

   be components of the rectangular coordinate path, and let

   {{< sicm-math >}}\widetilde{r}{{< /sicm-math >}}

   and

   {{< sicm-math >}}\widetilde{\varphi}{{< /sicm-math >}}
   ...
   . They are related by ([[/eval/sicm/chapter-1/#disp_1.64][1.64]]):
...
{\widetilde{x}(t) = \widetilde{r}(t)\cos\widetilde{\varphi}(t)} & \\
   ...
   . Differentiating ([[/eval/sicm/chapter-1/#disp_1.65][1.65]]) gives the relationship among the velocities
...
{C \circ \Gamma\lbrack q\prime\rbrack = \Gamma\lbrack q\rbrack.} & {(1.71)}
    ...
    satisfies equation ([[/eval/sicm/chapter-1/#disp_1.70][1.70]]) is

    @@html:<span id="disp_1.72"></span>@@
{{< sicm-math display >}}\begin{aligned}
{L\prime = L \circ C} & {(1.72)}
    \end{aligned}{{< /sicm-math >}}
    We can see this by substituting for /L/′ in equation ([[/eval/sicm/chapter-1/#disp_1.70][1.70]]):
...
{L\prime = L \circ C,} & {(1.78)}
    ...
    *Exercise 1.15: Equivalence*
    ...
    ([[/eval/sicm/chapter-1/#disp_1.77][1.77]]) to find the function /C/ that
...
'phidot)))))
    ...
    ([[/eval/sicm/chapter-1/#disp_1.72][1.72]]):
...
(define (L-central-polar m U) (compose
    ...
    ([[/eval/sicm/chapter-1/#disp_1.69][1.69]]).
...
{\mathbf{x}_{\alpha} = f_{\alpha}(t,q).} & {(1.79)}
   ...
   ([[/eval/sicm/chapter-1/#disp_1.79][1.79]]), differentiating, and abstracting
   to arbitrary velocities (see [[/eval/sicm/chapter-1/#h3_1-6-1][section
   1.6.1]]). We find
...
{\mathbf{v}_{\alpha} = \partial_{0}f_{\alpha}(t,q) + \partial_{1}f_{\alpha}(t,q)v.} & {(1.80)}
   \end{aligned}{{< /sicm-math >}}
   We use equations ([[/eval/sicm/chapter-1/#disp_1.79][1.79]]) and
   ([[/eval/sicm/chapter-1/#disp_1.80][1.80]]) to express the kinetic energy in
   terms of the generalized coordinates and velocities. Let

   {{< sicm-math >}}\widetilde{T}{{< /sicm-math >}}
...
{{< sicm-math display >}}\begin{array}{lll} {T(t,q,v)} & {= \widetilde{T}(t,f(t,q),\partial_{0}f(t,q) + \partial_{1}f(t,q)v)} & \\ & {= {\sum\limits_{\alpha}{\frac{1}{2}m_{\alpha}{(\partial_{0}f_{\alpha}(t,q) + \partial_{1}f_{\alpha}(t,q)v)}^{2}.}}} & {(1.82)}\end{array}{{< /sicm-math >}}
   Similarly, we use equation ([[/eval/sicm/chapter-1/#disp_1.79][1.79]]) to
   reexpress the potential energy in terms of the generalized coordinates. Let

   {{< sicm-math >}}\widetilde{V}(t,x){{< /sicm-math >}}
...
** A pendulum driven at the pivot
   ...
   :CLASS:    level2
   :END:
   Consider a pendulum (see [[/eval/sicm/chapter-1/#Fig_1-2][figure 1.2]]) of
   ...
   /θ/, shown in [[/eval/sicm/chapter-1/#Fig_1-2][figure 1.2]], as the
...
{{< sicm-math display >}}\begin{array}{llll} {v_{x} = l\dot{\theta}\cos\theta} & \text{and} & {v_{y} = Dy_{s}(t) + l\dot{\theta}\sin\theta,} & {(1.85)}\end{array}{{< /sicm-math >}}
   ...
   [[/eval/source/sicm/images/Art_P138.jpg]]
...
{\frac{x^{2}}{a^{2}} + \frac{y^{2}}{b^{2}} + \frac{z^{2}}{c^{2}} = 1} & {(1.89)}
   ...
   uniform vertical gravitational acceleration. [[/eval/source/sicm/images/Art_P146.jpg]]
   ...
   gravity. [[/eval/source/sicm/images/Art_P147.jpg]]

   @@html:<span id="Exe_1-19"></span>@@

   *Exercise 1.19: Two-bar linkage*

   The two-bar linkage shown in [[/eval/sicm/chapter-1/#Fig_1-3][figure 1.3]] is
   ...
   *Exercise 1.20: Sliding pendulum*
   ...
   horizontally, as shown in [[/eval/sicm/chapter-1/#Fig_1-4][figure 1.4]]. Let
...
{{(\mathbf{x}_{\beta}(t) - \mathbf{x}_{\alpha}(t))}^{2} - l_{\alpha\beta}^{2} = 0} & {(1.94)}
   ...
   ([[/eval/sicm/chapter-1/#disp_1.91][1.91]])
...
{\mathbf{x}_{\alpha} = f_{\alpha}(t,q,c).} & {(1.96)}
   ...
   *v*_{/α/} in terms of the generalized velocities
   ...
   arbitrary velocities (see [[/eval/sicm/chapter-1/#h3_1-6-1][section 1.6.1]]):
...
{\mathbf{v}_{\alpha} = \partial_{0}f_{\alpha}(t,q,c) + \partial_{1}f_{\alpha}(t,q,c)\,\,\dot{q} + \partial_{2}f_{\alpha}(t,q,c)\,\,\dot{c}.} & {(1.97)}
   ...
   ([[/eval/sicm/chapter-1/#disp_1.93][1.93]]), and using
...
{{< sicm-math display >}}\begin{array}{lll} {L''(t,q,\dot{q})} & {= {\sum\limits_{\alpha}{\frac{1}{2}m_{\alpha}{(\partial_{0}f_{\alpha}(t,q,l) + \partial_{1}f_{\alpha}(t,q,l)\,\,\dot{q})}^{2}}}} & \\ & {\,\,\, - V(t,f(t,q,l)),} & {(1.101)}\end{array}{{< /sicm-math >}}
   ...
   Lagrangian ([[/eval/sicm/chapter-1/#disp_1.99][1.99]]) in favor of Lagrangian
   ([[/eval/sicm/chapter-1/#disp_1.101][1.101]]), which is equivalent as far as
   ...
   particles in a plane. [[/eval/source/sicm/images/Art_P166.jpg]]
   ...
   *Exercise 1.21: A dumbbell*
   ...
   [[/eval/sicm/chapter-1/#Fig_1-5][figure 1.5]]. There are apparently four
   ...
   *Exercise 1.22: Driven pendulum*
   ...
   Show that the Lagrangian ([[/eval/sicm/chapter-1/#disp_1.93][1.93]]) can be
   used to describe the driven pendulum
   ([[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]]), where the position of the
   ...
   *Exercise 1.23: Fill in the details*
   ...
   ([[/eval/sicm/chapter-1/#disp_1.101][1.101]]) are the same as the Lagrange
   equations for Lagrangian ([[/eval/sicm/chapter-1/#disp_1.99][1.99]]) with the
...
{L_{f}(t;\mathbf{x}_{0},\ldots,\mathbf{x}_{N - 1};\mathbf{v}_{0},\ldots,\mathbf{v}_{N - 1})} & \\
    ...
    *x*_{/α/}, the coordinates of the constituent particles, by *x*_{/α/} =
    ...
    [[/eval/sicm/chapter-1/#h3_1-6-1][section 1.6.1]])
...
{L = L_{f} \circ C.} & {(1.104)}
    ...
    introduced in [[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]]. As we saw on
    [[https://tgvaughan.github.io/sicm/chapter001.html#p40][page 40]], the /T/ − /V/ Lagrangian for a free
...
'thetadot)))
    ...
    ([[/eval/sicm/chapter-1/#disp_1.88][1.88]]) on
    [[https://tgvaughan.github.io/sicm/chapter001.html#p51][page 51]].
...
{D_{t}F = \partial_{0}F + (\partial_{1}F)\dot{Q}.} & {(1.118)}
   ...
   (see [[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]]),
...
{ml^{2}D^{2}\theta(t) + ml(g + D^{2}y_{s}(t))\,\sin\theta(t) = 0,} & {(1.119)}
   ...
   [[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]]. However, we can write an
...
** Properties of total time derivatives
   ...
   From equation ([[/eval/sicm/chapter-1/#disp_1.112][1.112]]), we see that /G/
...
(show-expression (((Lagrange-equations-first-order
  ...
  /Dq/(/t/) components in the system derivative. [[/eval/source/sicm/images/Art_P208.jpg]]
...
** Numerical integration
   ...
   in [[/eval/sicm/chapter-1/#Fig_1-6][figure 1.6]]. The state derivative
...
1.8189103724750855))
   ...
   [[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]] with a periodic drive. We
...
(define ((monitor-theta win) state) (let ((theta
   ...
   simulation with initial conditions /θ/ = 1 and ¶ {{< sicm-math >}}\dot{\theta} = 0{{< /sicm-math >}} ¶
   ...
   initial angular velocity, ¶ {{< sicm-math >}}\dot{\theta} = 10^{- 10}{{< /sicm-math >}} ¶ . The initial
   ...
   with chaotic behavior. [[/eval/source/sicm/images/Art_P211.jpg]]
   ...
   *a.* Evolve the Foucault pendulum, using the Lagrangian you constructed in
   [[/eval/sicm/chapter-1/#Exe_1-25][exercise 1.25]] on
   [[https://tgvaughan.github.io/sicm/chapter001.html#p62][page 62]]. You should look at the precession
...
** Examples of conserved momenta
   ...
   ([[/eval/sicm/chapter-1/#h1-6a][section 1.6]]), the Lagrangian
...
{\mathcal{E} = 2T - T + V = T + V.} & {(1.147)}
   ...
   *Exercise 1.33: Falling off a log*
   ...
   [[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]], together with conservation
   of energy.
...
'phi) (up 'rdot 'thetadot 'phidot)))) {%
    ...
    [[/eval/sicm/chapter-1/#h1-6a][section 1.6]].
...
(define ((V a GM0 GM1 m) t xy) (let ((Omega (sqrt (/
    ...
    did on [[https://tgvaughan.github.io/sicm/chapter001.html#p48][page 48]]. The resulting Lagrangian is
...
{U_{r}(x_{r},y_{r}) = - \left( {\frac{GM_{0}}{r_{0}} + \frac{GM_{1}}{r_{1}} + \frac{1}{2}\Omega^{2}(x_{r}^{2} + y_{r}^{2})} \right).} & {(1.152)}
    ...
    ([[/eval/sicm/chapter-1/#disp_1.150][1.150]]).
    ...
    *Exercise 1.35: Restricted equations of motion*
    ...
    the Lagrangian ([[/eval/sicm/chapter-1/#disp_1.150][1.150]]). Identify the
...
{D_{t}(D\widetilde{F}(s)) = DG(s)\,\,\,\text{with}\,\,\, G\left( s \right) = D_{t}(\widetilde{F}(s)).} & {(1.158)}
    ...
    first term of equation ([[/eval/sicm/chapter-1/#disp_1.157][1.157]]):
...
{f = \overline{\Gamma}(\overline{f}).} & {(1.173)}
  \end{aligned}{{< /sicm-math >}}
  From equation ([[/eval/sicm/chapter-1/#disp_1.172][1.172]]) we see that
...
p->r) (up 't (up 'r 'theta) (up 'rdot 'thetadot))))
  ...
  ([[/eval/sicm/chapter-1/#disp_1.77][1.77]]) is not needed.
...
1))))) ((Gamma-bar DF-on-path) state))) DtF)
  ...
  *Exercise 1.37: Velocity transformation*
  ...
  ([[/eval/sicm/chapter-1/#disp_1.67][1.67]]) on [[https://tgvaughan.github.io/sicm/chapter001.html#p42][page
  42]].
...
** Lagrange equations at a moment
   ...
   Lagrange equations ([[/eval/sicm/chapter-1/#disp_1.12][1.12]]) for the
   Lagrangian /L/:
...
x))
   ...
   Using equation ([[/eval/sicm/chapter-1/#disp_1.179][1.179]]), the Lagrange
...
* 1.10 Constrained Motion
  ...
  of kinetic and potential energies (see [[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]]).
...
{\varphi(t,q(t),Dq(t)) = 0.} & {(1.181)}
  ...
  that led to Lagrange's equations (refer to [[/eval/sicm/chapter-1/#h1-6][section 1.5]])? Actually most of the
  calculation is unaffected. The condition that the action is stationary still
  reduces to the conditions ([[/eval/sicm/chapter-1/#disp_1.17][1.17]]) or ([[/eval/sicm/chapter-1/#disp_1.34][1.34]]):
...
{0 = {\int_{t_{1}}^{t_{2}}{\left\{ {(\partial_{1}L \circ \Gamma\lbrack q\rbrack) - D(\partial_{2}L \circ \Gamma\lbrack q\rbrack)} \right\}\eta.}}} & {(1.182)}
  \end{aligned}{{< /sicm-math >}}
  At this point we argued that because the variations {{< sicm-math >}}\eta{{< /sicm-math >}} are arbitrary
  ...
  of {{< sicm-math >}}\eta{{< /sicm-math >}} allowed us to deduce that the factor multiplying {{< sicm-math >}}\eta{{< /sicm-math >}} in the
  integrand must be identically zero, thereby deriving Lagrange's equations.

  Now the choice of {{< sicm-math >}}\eta{{< /sicm-math >}} is not completely free. We can still deduce from the
  arbitrariness of {{< sicm-math >}}\eta{{< /sicm-math >}} that the integrand must be zero,[fn:91] but we can no
  longer deduce that the factor multiplying {{< sicm-math >}}\eta{{< /sicm-math >}} is zero (only that the
...
{\left\{ {(\partial_{1}L \circ \Gamma\lbrack q\rbrack) - D(\partial_{2}L \circ \Gamma\lbrack q\rbrack)} \right\}\eta = 0,} & {(1.183)}
  \end{aligned}{{< /sicm-math >}}
  with {{< sicm-math >}}\eta{{< /sicm-math >}} subject to the constraints.
  ...
  variations {{< sicm-math >}}\eta{{< /sicm-math >}} for which the variation of the constraint is zero:
...
{\delta_{\eta}(\overline{\varphi}) = 0.} & {(1.184)}
  ...
  Expanding this with the chain rule, a variation {{< sicm-math >}}\eta{{< /sicm-math >}} is tangent to the
...
{(\partial_{1}\varphi \circ \Gamma)\,\,\,\eta = 0.} & {(1.186)}
    \end{aligned}{{< /sicm-math >}}
    Together, equations ([[/eval/sicm/chapter-1/#disp_1.183][1.183]]) and ([[/eval/sicm/chapter-1/#disp_1.186][1.186]]) should determine the motion, but how
    do we eliminate {{< sicm-math >}}\eta{{< /sicm-math >}}? The residual of the Lagrange equations is
    orthogonal[fn:92] to any {{< sicm-math >}}\eta{{< /sicm-math >}} that is orthogonal to the normal to the
...
{L\prime(t;q,\lambda;\dot{q},\dot{\lambda}) = L(t,q,\dot{q}) + \lambda\varphi(t,q,\dot{q}).} & {(1.188)}
   ...
   modified Lagrange equations ([[/eval/sicm/chapter-1/#disp_1.187][1.187]]), and the Lagrange equation associated
   ...
   that this Lagrangian is of the same form as the Lagrangian (equation [[/eval/sicm/chapter-1/#disp_1.93][1.93]])
   that we used in the derivation of /L/ = /T/ − /V/ for rigid systems
   ([[/eval/sicm/chapter-1/#h3_1-6-2][section 1.6.2]]).
...
** Alternatively
   ...
   function /λ/ from equations ([[/eval/sicm/chapter-1/#disp_1.187][1.187]]), or
   that the extra degree of freedom introduced in Lagrangian
   ([[/eval/sicm/chapter-1/#disp_1.188][1.188]]) is purely formal?
...
{L'' = L + \Lambda\varphi.} & {(1.189)}
   ...
   (see [[/eval/sicm/chapter-1/#h1-6d][section 1.9]]) to this Lagrangian
   gives[fn:93]
...
** The pendulum using constraints
   ...
   constant (see [[/eval/sicm/chapter-1/#Fig_1-8][figure 1.8]]).
...
** Building systems from parts
   ...
   Consider the compound spring-mass system shown at the top of [[/eval/sicm/chapter-1/#Fig_1-9][figure 1.9]]. We
   ...
   an additional configuration coordinate {{< sicm-math >}}\xi{{< /sicm-math >}}. We can formulate a Lagrangian
   for each part separately. We can then choose a Lagrangian for the composite
   system as the sum of the two component Lagrangians with a constraint {{< sicm-math >}}\xi{{< /sicm-math >}} =
...
{{< sicm-math display >}}\begin{aligned} {0 = \xi - (X_{1} + x_{1}).} & {(1.210)} \end{aligned}{{< /sicm-math >}}
   ...
   together. We can now eliminate the “glue” coordinates {{< sicm-math >}}\xi{{< /sicm-math >}} and /λ/ to obtain
...
{m_{2}(D^{2}x_{1} + D^{2}x_{2}) + k_{2}x_{2} = 0.} & {(1.212)}
   ...
   /x/_{1}. [[/eval/source/sicm/images/Art_P326.jpg]]
   ...
   *Exercise 1.40: Bead on a triaxial surface*
   ...
   ([[/eval/sicm/chapter-1/#Exe_1-18][exercise 1.18]]). Reformulate this using rectangular coordinates as the
   ...
   equivalent to those found in [[/eval/sicm/chapter-1/#Exe_1-18][exercise 1.18]].
...
{\mathcal{E}\lbrack L\rbrack \circ \Gamma\lbrack q\rbrack - \lambda(\partial_{1}\varphi \circ \Gamma\lbrack q\rbrack) = 0.} & {(1.216)}
    \end{aligned}{{< /sicm-math >}}
    From equation ([[/eval/sicm/chapter-1/#disp_1.214][1.214]]) we see that
...
{\mathcal{E}\lbrack L\rbrack \circ \Gamma\lbrack q\rbrack = - D\lambda\prime(\partial_{2}\psi \circ \Gamma\lbrack q\rbrack),} & {(1.220)}
    ...
    equations ([[/eval/sicm/chapter-1/#disp_1.218][1.218]]).
    ...
    an inclined plane. [[/eval/source/sicm/images/Art_P335.jpg]]
    ...
    *Exercise 1.42: Augmented Lagrangian*
    ...
    ([[/eval/sicm/chapter-1/#disp_1.219][1.219]]) does lead to the Lagrange
    equations ([[/eval/sicm/chapter-1/#disp_1.220][1.220]]), taking into account
...
** Goldstein's hoop
   ...
   [[/eval/sicm/chapter-1/#Fig_1-10][figure 1.10]]).[fn:96]
...
{\mathcal{E}\lbrack L\rbrack \circ \Gamma\lbrack q\rbrack = \lambda(G_{1} \circ \Gamma\lbrack q\rbrack) = \lambda(\partial_{2}\psi \circ \Gamma\lbrack q\rbrack).} & {(1.231)}
    ...
    identical to the Lagrange equations ([[/eval/sicm/chapter-1/#disp_1.218][1.218]]) for the case that /ψ/ is a total
...
\end{aligned}{{< /sicm-math >}}
    ...
    is orthogonal to {{< sicm-math >}}\eta{{< /sicm-math >}} and {{< sicm-math >}}\eta{{< /sicm-math >}} is constrained to be orthogonal to
...
{\mathcal{E}\lbrack L\rbrack \circ \Gamma\lbrack q\rbrack = \lambda(\partial_{1}\varphi \circ \Gamma\lbrack q\rbrack).} & {(1.234)}
    ...
    velocity. In this case, for a variation {{< sicm-math >}}\eta{{< /sicm-math >}} to be consistent with the
    velocity-dependent constraint function /ψ/ it must satisfy (see equation
    [[/eval/sicm/chapter-1/#disp_1.185][1.185]])
...
{(\partial_{1}\psi \circ \Gamma\lbrack q\rbrack)\eta + (\partial_{2}\psi \circ \Gamma\lbrack q\rbrack)D\eta = 0.} & {(1.235)}
    \end{aligned}{{< /sicm-math >}}
    We may no longer eliminate {{< sicm-math >}}\eta{{< /sicm-math >}} by the same argument, because {{< sicm-math >}}\eta{{< /sicm-math >}} is no
    ...
    al. [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_6][6]]], translated into our notation. Define a “virtual velocity” {{< sicm-math >}}\xi{{< /sicm-math >}} to
...
{(\mathcal{E}\lbrack L\rbrack \circ \Gamma\lbrack q\rbrack)\xi = 0,} & {(1.237)}
    \end{aligned}{{< /sicm-math >}}
    for any virtual velocity {{< sicm-math >}}\xi{{< /sicm-math >}}. Because {{< sicm-math >}}\xi{{< /sicm-math >}} is arbitrary except that it is
    required to be orthogonal to ∂_{2}/ψ/ ∘ Γ[/q/] and any such {{< sicm-math >}}\xi{{< /sicm-math >}} is
    orthogonal to
...
{\mathcal{E}\lbrack L\rbrack \circ \Gamma\lbrack q\rbrack = \lambda(\partial_{2}\psi \circ \Gamma\lbrack q\rbrack),} & {(1.238)}
    ...
    must do the following. To get from equation ([[/eval/sicm/chapter-1/#disp_1.232][1.232]]) to equation ([[/eval/sicm/chapter-1/#disp_1.237][1.237]]), we
    must replace {{< sicm-math >}}\eta{{< /sicm-math >}} by {{< sicm-math >}}\xi{{< /sicm-math >}}. However, to get from equation ([[/eval/sicm/chapter-1/#disp_1.235][1.235]]) to
    equation ([[/eval/sicm/chapter-1/#disp_1.236][1.236]]), we must set {{< sicm-math >}}\eta = 0{{< /sicm-math >}} and replace /Dη/ by {{< sicm-math >}}\xi{{< /sicm-math >}}. All
    ...
    same as the non-holonomic system (equations [[/eval/sicm/chapter-1/#disp_1.231][1.231]]).[fn:99] Let /L/′ be an
...
{\psi \circ \Gamma\lbrack q\rbrack = 0.} & {(1.241)}
    ...
    In general, for any particular physical system, equations ([[/eval/sicm/chapter-1/#disp_1.231][1.231]]) and
    ([[/eval/sicm/chapter-1/#disp_1.240][1.240]]) are not the same, and in fact they have different solutions. It is
...
* 1.12 Projects
  ...
  *a.* The angle is periodic in time, so a Fourier series representation is
  ...
  [[/eval/sicm/chapter-1/#h1-5][section 1.4]]. Watch out: there is more than one
  ...
  *Exercise 1.44: Double pendulum behavior*
  ...
  [[/eval/sicm/chapter-1/#Fig_1-11][figure 1.11]].
  ...
  *d.* Make a new Lagrangian, for two identical uncoupled double pendulums.
  ...
  that its members are free to move in a plane. [[/eval/source/sicm/images/Art_P363.jpg]]
...
systems with non-integrable constraints in [[/eval/sicm/chapter-1/#h3_1-10-3][section 1.10.3]]. Apart from that
...
[fn:9] Here {{< sicm-math >}}\circ{{< /sicm-math >}} denotes composition of functions:

{{< sicm-math display >}}(f \circ g)(t) = f(g(t)){{< /sicm-math >}}

[fn:10] The derivative of a function {{< sicm-math >}}f{{< /sicm-math >}} is a function, denoted {{< sicm-math >}}Df{{< /sicm-math >}}. Our
notational convention is that {{< sicm-math >}}D{{< /sicm-math >}} is a high-precedence operator. Thus {{< sicm-math >}}D{{< /sicm-math >}}
operates on the adjacent function before any other application occurs: {{< sicm-math >}}Df(x){{< /sicm-math >}}
is the same as {{< sicm-math >}}(Df)(x){{< /sicm-math >}}.
...
[fn:15] A definite integral of a real-valued function {{< sicm-math >}}f{{< /sicm-math >}} of a real argument is
written
...
the formulation of the principle of least action, see [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_28][28]]].
...
[fn:36] The squared magnitude of the velocity is {{< sicm-math >}}\overset{\rightarrow}{v} \cdot
...
Lagrangian. We will get to this in [[/eval/sicm/chapter-1/#h1-6a][section 1.6]].
...
[fn:54] The symbol {{< sicm-math >}}\dot{\theta}{{< /sicm-math >}}
...
bounded by a constant in an open set around each state. See [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_25][25]]] for a good
...
the 20th century. See [[/eval/sicm/chapter-1/#h3_1-8-5][section 1.8.5]] on Noether's theorem.
...
[fn:90] This F->C is more general than the code introduced on [[https://tgvaughan.github.io/sicm/chapter001.html#p46][page 46]] in that it
...
[fn:93] Recall that the Euler--Lagrange operator {{< sicm-math >}}\mathcal{E}{{< /sicm-math >}}
...
[fn:96] This example appears in [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_20][20]]], pp. 49--51.
...
[[[https://tgvaughan.github.io/sicm/bibliography.html#bib_46][46]]], Goldstein [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_20][20]]], Gantmakher [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_19][19]]], or Arnold et al. [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_6][6]]].

[fn:99] Arnold et al. [[[https://tgvaughan.github.io/sicm/bibliography.html#bib_6][6]]] call the variational mechanics with the constraints
